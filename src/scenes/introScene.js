export class IntroScene extends Phaser.Scene {
    ...
    create() {
        ...
        let playButtonIntro = this.add.image(495, 440, 'playButton').setOrigin(0, 0);
        let hoverPlayButtonIntro = this.add.image(495, 440, 'playButtonHover').setOrigin(0, 0);
        hoverPlayButtonIntro.setVisible(false);

        let menuButtonIntro = this.add.image(95, 440, 'menuButton').setOrigin(0, 0);
        let hoverMenuButtonIntro = this.add.image(95, 440, 'menuButtonHover').setOrigin(0, 0);
