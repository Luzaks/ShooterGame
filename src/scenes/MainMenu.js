...
export default class MainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    const playButtonMainMenu = this.add.image(293, 205, 'playButton').setOrigin(0, 0);
    const hoverPlayButtonMainMenu = this.add.image(293, 206, 'hoverPlayButton').setOrigin(0, 0);
    hoverPlayButtonMainMenu.setVisible(false);

    const introButtonMainMenu = this.add.image(293, 305, 'introButton').setOrigin(0, 0);
    const hoverIntroButtonMainMenu = this.add.image(293, 305, 'hoverIntroButton').setOrigin(0, 0);
    hoverIntroButtonMainMenu.setVisible(false);

    const commandsButtonMainMenu = this.add.image(293, 405, 'commandsButton').setOrigin(0, 0);
    const hoverCommandsButtonMainMenu = this.add.image(293, 405, 'hoverCommandsButton').setOrigin(0, 0);
    hoverCommandsButtonMainMenu.setVisible(false);

    const rankingButtonMainMenu = this.add.image(293, 505, 'rankButton').setOrigin(0, 0);
    const hoverRankingButtonMainMenu = this.add.image(293, 505, 'hoverRankButton').setOrigin(0, 0);
    ...
    const song = this.sfx.mainMenuSong;
